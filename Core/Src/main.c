...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, RELAY_RSEL_1K_Pin|RELAY_RSEL_10K_Pin|RELAY_RSEL_100K_Pin|RELAY_PORT_A_Pin
                          |RELAY_PORT_B_Pin|RELAY_PORT_C_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(RELAY_PORT_D_GPIO_Port, RELAY_PORT_D_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : KEY_MEAS_BASIC_Pin KEY_MEAS_EXTEND_Pin */
  GPIO_InitStruct.Pin = KEY_MEAS_BASIC_Pin|KEY_MEAS_EXTEND_Pin;
